...
import laminar.domtestutils.scalatest.LaminarSpec
import org.scalajs.dom

import scala.collection.mutable

// Taken from Laminar lib, to prove we can also write tests that use the mount method
class SplitVarSpec extends LaminarSpec:
